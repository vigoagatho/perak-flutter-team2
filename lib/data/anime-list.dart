class AnimeList {
  ...
  final List<String> gambarrekomen = [
  ...
  final List<String> judulrekomen = [
    'One Punch Man',
    'Blue Lock',
    'Dragon Ball Z',
    'Hunter x Hunter'
  ];
  final List<String> gambarlanjut = [
  ...
  final List<String> episode = ['7', '23', '25', '14', '21'];
  final List<String> persen = ['30%', '70%', '20%', '45%', '90%'];
}
